...
今回はCMLを操作するPythonスクリプトをFastMCPでラッピングしたものを使います。
...
今回はGPT-5 miniを使いましたが、学習モデルが違うとうまく動かないかもしれません。

そういう危うさはあるものの、
推論によって結論を導く方法は、ラボの構成に関係なく使える汎用性の高さがあって、
特定のラボでしか使えないスクリプトを使い捨てのように作り続けるよりも、トータルの生産性は高いかもしれません。
